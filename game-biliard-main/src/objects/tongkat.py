...
class Tongkat:
    ...
    def __init__(self, asset_dir=None):
        ...
        self.shadow_ball_alpha = 160  
        self.shadow_spacing = 64  
        self.max_shadow_markers = 6  

       
        self.max_reflections = 2
        self.max_total_len = 700.0  
    ...
    def draw(self, surface):
        ...
        pygame.draw.circle(surface, (255, 80, 80), (int(bx), int(by)), 3)  
        pygame.draw.circle(surface, (80, 200, 255), (int(mx), int(my)), 6) 
